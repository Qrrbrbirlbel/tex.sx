...
### How-to
We start with the triangle:
 1. Draw circles
  - around *A* through *B* (`cAB`),
  - around *A* through *C* (`cAC`),
  - and later (see step 4) a circle around *C* through any point so that the circle is big enough to intersect the line through *B'* and *C'*.
 2. Intersection circle `cAB` with line thorugh *A* and *C* (`lAC`), the intersection is `B'`.
 3. Intersection circle `cAC` with line through A* and *B* (`lAB`), the intersection is `C'`.
 4. Find 
